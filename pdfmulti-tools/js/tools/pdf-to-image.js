document.addEventListener('DOMContentLoaded', function() {
    ...
    [imageFormat, imageQuality, imageResolution, removeBackground, enhanceText, optimizeColors].forEach(element => {
    ...
    function updateConversionTimeEstimate() {
        ...
        if (imageFormat.value === 'tiff') baseTime += 2;
        if (imageFormat.value === 'webp') baseTime += 1;
    ...
    convertBtn.addEventListener('click', async function() {
        ...
        try {
            // Here you would implement the actual PDF to image conversion logic
            ...
            downloadLink.download = `converted-images.${imageFormat.value === 'jpeg' ? 'zip' : imageFormat.value}`;
            downloadLink.click();
        } catch (error) {
